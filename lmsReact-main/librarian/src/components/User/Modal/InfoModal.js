...
import { userImageRequesterFunc } from '../../../action/librarianUserAction'
import InfoModalBody from './InfoModalBody'

const InfoModal = (props) => {
  const userImageRequest = useSelector((store) => store.userImageRequest)

  const dispatch = useDispatch()
  const { response, error, loading } = userImageRequest
  ...
  const handleShow = () => {
    ...
    dispatch(userImageRequesterFunc(props.id))
  }
