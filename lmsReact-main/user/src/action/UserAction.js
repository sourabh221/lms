...
export const signUp = (
  ...
  return (dispatch) => {
    ...
    const url = 'http://localhost:4040/backend/user/signup'
    axios
...
export const signIn = (email, pwd) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:4040/backend/user/login'
...
export const requestOtpFunc = (email) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:4040/backend/user/send-otp'
...
export const resetPassFunc = (email, pwd) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:4040/backend/user/update-password'
...
export const profilePicUploadFunc = (file, serialNo) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:4040/backend/user/image-upload'
...
export const getProfileFunc = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:4040/backend/user/get-profile'
...
export const getProfilePicFunc = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:4040/backend/user/image-download'
...
export const UpdateProfileFunc = (
  ...
  return (dispatch) => {
    ...
    const url = 'http://localhost:4040/backend/user/update-profile'
    axios
      .put(url, body, header)
      .then((response) => {
        dispatch({
